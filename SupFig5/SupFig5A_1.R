...
x <- read.table("allvariantshighly.txt", sep="\t", head=T, quote="\"", stringsAsFactors=F, na="")
...
cols <- colors()[c(109,81,508,84,471,11,132,494)]
...
tiff("PieVariantClassHighlyHyper.tif", width=24*300, height=12*300, res=300, compression="lzw")
